...
public abstract class Unit : MonoBehaviour
{
    ...
    // How close to get to waypoint before moving towards next. Fixes movement bug. +
    ...
    // Distance to stop before target if target is occupying selected space
